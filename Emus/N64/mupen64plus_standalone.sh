...
if [ -n "$VideoPlugin" ]; then
	/mnt/SDCARD/System/usr/trimui/scripts/set_ra_cfg.sh "$PWD/mupen64plus.cfg" "VideoPlugin" "mupen64plus-video-rice.so"
else
	...
	if [ -n "$VideoPlugin" ]; then
		/mnt/SDCARD/System/usr/trimui/scripts/set_ra_cfg.sh "$PWD/mupen64plus.cfg" "aspect" "1"
	else
		/mnt/SDCARD/System/usr/trimui/scripts/set_ra_cfg.sh "$PWD/mupen64plus.cfg" "aspect" "0"
	fi
	/mnt/SDCARD/System/usr/trimui/scripts/set_ra_cfg.sh "$PWD/mupen64plus.cfg" "VideoPlugin" "mupen64plus-video-glide64mk2.so"
fi
