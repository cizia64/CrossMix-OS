...
Username=$(get_ra_cfg.sh "$ConfigFile" "cheevos_username")
Password=$(get_ra_cfg.sh "$ConfigFile" "cheevos_password")
...
Token=$(get_ra_cfg.sh "$ConfigFile" "cheevos_token")
...
# PPSSPP 1.15.4
sed -i "s/AchievementsUserName =.*/AchievementsUserName = \"$Username\"/" /mnt/SDCARD/Emus/PSP/PPSSPP_1.15.4/.config/ppsspp/PSP/SYSTEM/ppsspp.ini
echo "$Token" >/mnt/SDCARD/Emus/PSP/PPSSPP_1.15.4/.config/ppsspp/PSP/SYSTEM/ppsspp_retroachievements.dat
