...
cp -ru "$BCK_DIR/Emus/PSP/**/.config/ppsspp/PSP/SAVEDATA/"* "/mnt/SDCARD/Emus/PSP/.config/ppsspp/PSP/SAVEDATA/"
cp -ru "$BCK_DIR/Emus/PSP/**/.config/ppsspp/PSP/PPSSPP_STATE/"* "/mnt/SDCARD/Emus/PSP/.config/ppsspp/PSP/PPSSPP_STATE/"
cp "$BCK_DIR/Emus/PSP/**/.config/ppsspp/PSP/SYSTEM/"*.dat "/mnt/SDCARD/Emus/PSP/.config/ppsspp/PSP/SYSTEM/"
cp -ru "$BCK_DIR/Emus/PSP/**/.config/ppsspp/PSP/Cheats/"*.ini "/mnt/SDCARD/Emus/PSP/.config/ppsspp/PSP/Cheats/"
cp -ru "$BCK_DIR/Emus/PSP/**/.config/ppsspp/PSP/GAME/"* "/mnt/SDCARD/Emus/PSP/.config/ppsspp/PSP/GAME/"
cp -ru "$BCK_DIR/Emus/PSP/**/.config/ppsspp/PSP/TEXTURES/"* "/mnt/SDCARD/Emus/PSP/.config/ppsspp/PSP/TEXTURES/"
