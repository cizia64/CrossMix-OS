...
Remote_HotfixVersion="1.3.9.1"
Remote_HotfixDate="2026-02-04"
Remote_HotfixDesc="- SSH fix for beta tests"
###########################################################################################
...
get_hotfix_info() {
    ...
    download_file "Update Splitter" "https://raw.githubusercontent.com/$GITHUB_REPOSITORY/main/_assets/scripts/updatesplitter" -d "/mnt/SDCARD/System/bin"
    eval "$(updatesplitter)"
